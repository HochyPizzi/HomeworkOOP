...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        Product chocolate1 = new Chocolate("Аленка", "Шоколадка", 76, 544);
        Product chocolate2 = new Chocolate("Милка", "Шоколадка", 156, 986);
        ...
        Chocolate chocolateResult = vendingMachine.getChocolate(544);
